...
def simplePolygonTest_lga(lat,lon):
    ...
    poly7 = Polygon([Point(40.794635, -73.972868), Point(40.795376, -73.972300), Point(40.794679, -73.970674), Point(40.793976, -73.971245), Point(40.794635, -73.972868)])
				...
				if ((l[0].upper() == 'DATE' or lat == '' or lon == '' or lat == '0' or lon == '0') or (int(l[10]) == 0 and int(l[11]) == 0)):
						...
						try:
								...
								if not(crime):
										...
										year = date.split('/')[2]
										month = date.split('/')[0]
										injured_killed = int(l[10]) + int(l[11])
					
										if(int(year) >= 2011 and int(year) <= 2016):
											print "%s\t%d" %(year+'-'+month,injured_killed)
